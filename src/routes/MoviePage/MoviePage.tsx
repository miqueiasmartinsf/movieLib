...
const MoviePage = ():ReactElement => {
    ...
    const fetchCurrentMovie = async() => {
        ...
        const res = await fetch(`https://api.themoviedb.org/3/movie/${movieId.id}`,{method:'GET',headers:myHeader});
        ...
        <div className={styles.movie_page}>
            ...
            <div className={styles.movie_details}>
                <div className={styles.img_container}>
                    ...
                    <span> <BsStar/> {movieDetail.vote_average} </span>
                ...
                <div className={styles.movie_description}>
                    ...
                    <section className={styles.info}>
                        <h2><AiOutlineLineChart/> Receita:</h2>
                        <p>{movieDetail.revenue}</p>
                    </section>
                    <section className={styles.info}>
                        <h2><BiTimeFive/> Duração:</h2>
                        <p>{movieDetail.runtime} minutos</p>
                    </section>
                    <section className={styles.info}>
                        <h2><MdOutlineDescription/> Descrição:</h2>
